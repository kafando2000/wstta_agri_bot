...
bool custom_interfaces__msg__custom_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // mystring
    PyObject * field = PyObject_GetAttrString(_pymsg, "mystring");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->mystring, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // myint
    PyObject * field = PyObject_GetAttrString(_pymsg, "myint");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->myint = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * custom_interfaces__msg__custom_message__convert_to_py(void * raw_ros_message)
{
  ...
  {  // mystring
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->mystring.data,
      strlen(ros_message->mystring.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "mystring", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // myint
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->myint);
    {
      int rc = PyObject_SetAttrString(_pymessage, "myint", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
