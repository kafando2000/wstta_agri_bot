...
class CustomMessage(metaclass=Metaclass_CustomMessage):
    ...
    def __init__(self, **kwargs):
        ...
        self.mystring = kwargs.get('mystring', str())
        self.myint = kwargs.get('myint', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mystring != other.mystring:
            return False
        if self.myint != other.myint:
            return False
        return True
    ...
    def mystring(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'mystring' field must be of type 'str'"
        self._mystring = value
    ...
    def myint(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'myint' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'myint' field must be an integer in [-2147483648, 2147483647]"
        self._myint = value
