...
#include "mm_nav/nav2_behaviors.hpp"

using namespace std::chrono_literals;

const std::string default_bt_xml_file = 
    ament_index_cpp::get_package_share_directory("mm_nav") + "/bt_xml/nav_tree.xml";
const std::string tb_worlds_share_dir = 
    ament_index_cpp::get_package_share_directory("mm_nav");
const std::string default_location_file =
    tb_worlds_share_dir + "/config/map_locations.yaml";


class AutonomyNode : public rclcpp::Node {
    public:
        AutonomyNode() : Node("nav2_bt_client") {
